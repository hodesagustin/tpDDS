...
namespace OrganizadorFutbol5
{
	...
	[Table(Name="grupo1.Calificacion")]
	...
	[Table(Name="grupo1.CalificacionPendiente")]
    ...
    partial void OnMotivoChanged();
		...
		[Column(Storage="_Fecha", DbType="Date NOT NULL", IsPrimaryKey=true)]
		public System.DateTime Fecha
		{
			get
			{
	...
	[Table(Name="grupo1.InscripcionPendiente")]
    ...
    partial void OnHandicapChanged();
		...
		[Column(Storage="_Edad", DbType="TinyInt NOT NULL")]
		public byte Edad
		{
			get
			{
	...
	[Table(Name="grupo1.JugadorAmigo")]
	...
	[Table(Name="grupo1.PartidoEquipo")]
